...
if [ -d '/usr/local/ddos' ]; then
	...
	echo; echo; echo "Please un-install the previous version first"	exit 0
...
wget -O addhost "https://raw.githubusercontent.com/ajidanang123/deb9-10/main/tambah/addhost.sh"
